...
* 通用 Analytics (分析) 資源不包括「使用者多層檢視」報表。

* Google Analytics (分析) 4 資源不包括報表或探索匯出功能、查看裝置 ID 維度的功能，或使用探索工作區的「使用者探索」技巧。

* 針對任一資源類型，您無法透過 Analytics Reporting API 使用示範帳戶，這麼做會發生權限錯誤。

### 移除示範帳戶存取權(可以隨時再次取得示範帳戶的存取權)
